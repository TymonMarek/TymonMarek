<p align="center">
  <img
    src="./banner.png"
    alt='Illustration of a quote by Richard Feynman: "What I cannot create, I do not understand."'
    width="100%"
  />
</p>
...
TypeScript           27 hrs 37 mins        >>>>>>>>>>>>>>===========   56.70 %
JSON                 8 hrs 58 mins         >>>>>====================   18.42 %
Python               2 hrs 12 mins         >========================   04.53 %
TSConfig             1 hr 38 mins          >========================   03.36 %
Other                1 hr 37 mins          >========================   03.33 %
```
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=zig,cpp,cmake,nix,unity,unreal,arduino,deno,flutter,kotlin,azure,gcp" />
</p>
